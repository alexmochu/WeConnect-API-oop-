...
class TestUserAccountsTestCases(unittest.TestCase):
    ...
    def test_special_characters(self):
        ...
        msg = self.user.register("chairman$", "mochualex4@gmail.com", "qwerW234#", "qwerW234#")
    ...
    def test_invalid_email(self):
        ...
        msg = self.user.register("chairman", "mochualex4gmail.com", "qwerW234#", "qwerW234#")
        self.assertEqual(msg, {"message":"Please a provide a valid email"})

    def test_password_mismatch(self):
        """ Test to check if the users password are not matching"""
        msg = self.user.register("chairman", "mochualex4@gmail.com", "qwerW234#", "qwherWER4")
    ...
    def test_existing_user(self):
        ...
        self.user.register("chairman", "mochualex4@gmail.com", "qwerW234#", "qwerW234#")
    ...
    def test_if_user_is_registered(self):
        ...
        self.user.users_list = [{'username': 'chairman', 'password': 'qwerW234#', \
                                'email': 'mochualex4@gmail.com'}]
        msg = self.user.login("Dolf", "qwerW234#")
    ...
    def test_correct_login(self):
        ...
        self.user.users_list = [{'username': 'chairman', 'password': 'qwerW234#', \
                                'email': 'mochualex4@gmail.com'}]
        msg = self.user.login("chairman", "qwerW234#")
